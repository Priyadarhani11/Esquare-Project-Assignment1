 ...
 * @generated
 */
public abstract class MyEntityFinderBaseImpl
	extends BasePersistenceImpl<MyEntity> {

	public MyEntityFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return myEntityPersistence.getBadColumnNames();
	}
