 ...
 * <code>com.custom.service.impl.MyEntityLocalServiceImpl</code> and
...
public class MyEntityLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.custom.service.impl.MyEntityLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MyEntity addMyEntity(MyEntity myEntity) {
		return getService().addMyEntity(myEntity);
	}
	 ...
	 */
	public static MyEntity createMyEntity(long id) {
		return getService().createMyEntity(id);
	}
	 ...
	 */
	public static MyEntity deleteMyEntity(long id) throws PortalException {
		return getService().deleteMyEntity(id);
	}
	 ...
	 * @return the my entity that was removed
	 */
	public static MyEntity deleteMyEntity(MyEntity myEntity) {
		return getService().deleteMyEntity(myEntity);
	}
	...
	public static MyEntity fetchMyEntity(long id) {
		return getService().fetchMyEntity(id);
	}
	 ...
	 */
	public static List<MyEntity> getMyEntities(int start, int end) {
		return getService().getMyEntities(start, end);
	}
	 ...
	 */
	public static int getMyEntitiesCount() {
		return getService().getMyEntitiesCount();
	}
	 ...
	 * @throws PortalException if a my entity with the primary key could not be found
	 */
	public static MyEntity getMyEntity(long id) throws PortalException {
		return getService().getMyEntity(id);
	}
	 ...
	 */
	public static MyEntity updateMyEntity(MyEntity myEntity) {
		return getService().updateMyEntity(myEntity);
	}
	...
	public static void setService(MyEntityLocalService service) {
		_service = service;
	}

	private static volatile MyEntityLocalService _service;
