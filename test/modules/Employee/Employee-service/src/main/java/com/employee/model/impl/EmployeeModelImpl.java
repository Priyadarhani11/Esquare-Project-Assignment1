...
public class EmployeeModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table EMPLOYEE_Employee (uuid_ VARCHAR(75) null,employeeId LONG not null primary key,employeeName VARCHAR(75) null,employeeAddress VARCHAR(75) null)";
